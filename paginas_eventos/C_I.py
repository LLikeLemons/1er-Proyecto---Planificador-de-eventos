...
def capacitacion_intructor(editor=False,editable_event=None, index=None):
    ...
    col2.subheader("Cursos de Capacitación: Capacitación de Instructores", divider="red")
...
#=========| VARIABLES DE EDITOR PARA CONFIGURACION PREDETERMINADA   |=============================================================================
    ...
    places_options = ["Aula 1", "Aula 2", "Aula 3","Salón de Reuniones"]
    if editor:
...
#========|   CREACION DEL EVENTO   |===============================================================================================================
    ...
    new_event = Event(date_input,(time_1,time_2),"Capacitación de Instructores",dict,place,frecuency_type,frecuency,attempts)
