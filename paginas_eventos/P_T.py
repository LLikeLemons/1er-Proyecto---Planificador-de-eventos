...
def practica_tiro(editor=False,editable_event=None, index=None):
    ...
    col2.subheader("Entrenamientos: Prácticas de Tiro", divider="red")
...
#=========| VARIABLES DE EDITOR PARA CONFIGURACION PREDETERMINADA   |=============================================================================
    ...
    places_options = ["Centro de entrenamiento", "Academia Policial"]
    if editor:
        ...
        bp_variable = editable_event.resources["Blancos de práctica"]
    ...
    with col7:        
        pist = st.number_input("Cantidad de pistolas",value=pist_variable, min_value=0, max_value=70)
        amp = st.number_input("Cantidad de AMP", value=amp_variable, min_value=0, max_value=50)
        esc = st.number_input("Cantidad de escopetas", value=esc_variable, min_value=0, max_value=50)
    with col6:
        inst = st.number_input("Cantidad de instructores", value=inst_variable, min_value=1,max_value=30)        
        bp = st.number_input("Cantidad de blancos de práctca", value=bp_variable, min_value=1, max_value= 30)
        place = st.selectbox("Lugar de práctica", places_options,index=place_variable)
...
#========|   CREACION DEL EVENTO   |===============================================================================================================
    ...
    dict = {
        "AMP": amp,
        "Blancos de práctica": bp,
        "Escopetas": esc,
        "Instructores": inst,
        "Pistolas": pist
    }
    new_event = Event(date_input,(time_1,time_2),"Prácticas de Tiro",dict,place,frecuency_type,frecuency,attempts)
