...
def capacitacion_swat(editor=False,editable_event=None, index=None):
    ...
    col2.subheader("Cursos de Capacitación: Capacitación SWAT", divider="red")
...
#=========| VARIABLES DE EDITOR PARA CONFIGURACION PREDETERMINADA   |=============================================================================
    ...
    places_options = ["Salón de Reuniones"]
    if editor:
        ...
        ltI_variable = editable_event.resources["Libro de capacitación para agentes I"]
        ltII_variable = editable_event.resources["Libro de capacitación para agentes II"]
    ...
    with col7:        
        ar = st.number_input("Cantidad de oficiales de alto rango",value=ar_variable, min_value=1, max_value=7)
    ...
    with col6:
        ltI = st.number_input("Libros de capacitación para agentes I", value=ltI_variable, min_value=0, max_value=50)
        ltII = st.number_input("Libros de capacitación para agentes II", value=ltII_variable, min_value=0, max_value=50)
        place = st.selectbox("Lugar de capacitación", places_options, index=place_variable)
...
#========|   CREACION DEL EVENTO   |===============================================================================================================
    ...
    dict = {        
        "Instructores": inst,        
        "Libro de capacitación para agentes I": ltI,
        "Libro de capacitación para agentes II": ltII,
        "Oficiales de alto rango": ar,
        "Proyectores": proy
    }
    new_event = Event(date_input,(time_1,time_2),"Capacitación SWAT",dict,place,frecuency_type,frecuency,attempts)
